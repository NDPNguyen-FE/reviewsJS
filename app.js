...
showPerson = () => {
  const newPerson = reviews[currentItem];
  imgPerson.src = newPerson["img"];
  namePerson.textContent = newPerson.name;
  jobPerson.textContent = newPerson.job;
  infoPerson.textContent = newPerson.text;
};
